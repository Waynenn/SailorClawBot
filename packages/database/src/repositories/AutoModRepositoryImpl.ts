...
import type { AutoModRepository } from '@sailorclawbot/contracts';
import type { AutoModRuleDto } from '@sailorclawbot/contracts';
...
export class AutoModRepositoryImpl implements AutoModRepository {
  ...
  public async upsert(
    ...
    const prismaConfig = config as Parameters<typeof this.prisma.autoModRule.upsert>[0]['create']['config'];
