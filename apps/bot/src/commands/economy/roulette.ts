...
export const rouletteCommand: Command = {
	data: new SlashCommandBuilder()
		...
		.addStringOption((o) =>
			o
				.setName("bet")
				.setDescription("red, black, even, odd, or a number 0-36")
				.setRequired(true),
		)
		.addIntegerOption((o) =>
			o
	...
	async execute(
		...
		try {
			...
			const { number, color, won, payout, multiplier, wallet } =
				await container.economyService.roulette(guildId, userId, bet, amount, {
